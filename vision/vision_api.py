"""FastAPI vision inference service — fracture detection pipeline."""
...
THRESHOLD = float(os.environ.get("FRACTURE_THRESHOLD", "0.0853"))
...
def analyze_url(req: AnalyzeUrlRequest) -> AnalyzeResponse:
    """Fetch image from URL and run full pipeline."""
